					...
					<div class="card-body">
						...
						<form>
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" class="form-control" name="aspek_rubrik" placeholder="Pilih aspek" readonly="readonly"> 
								</div>	
							</div>
							<div class="form-group">
								<label class="control-label col-sm-12" for="kegiatan_rubrik">Kegiatan:</label>
								<div class="col-sm-8">
									<textarea rows="7" class="form-control" name="kegiatan_rubrik" placeholder="Pilih kegiatan" readonly="readonly"></textarea>
								</div>	
							</div>
							<div class="form-group">
								<label class="control-label col-sm-12" for="poin">Poin</label>
								<div class="col-sm-2">
									<input type="text" class="form-control" name="poin" readonly="readonly" placeholder="Poin berkas"> 
								</div>	
							</div>
							<div class="form-group">
								<label class="control-label col-sm-12" for="bukti_berkas">Bukti:</label>
								<div class="col-sm-8">
									<input type="text" class="form-control" name="bukti_berkas" placeholder="Masukkan link google drive" readonly="readonly"> 
								</div>	
							</div>
							<div class="form-group">
								<label class="control-label col-sm-12" for="volume">Volume:</label>
								<div class="col-sm-2">
									<input type="text" class="form-control" name="volume" placeholder="Volume" readonly="readonly"> 
								</div>	
							</div>
							<input type="submit" name="simpan" value="Simpan Berkas" style="margin: 0 0 0 53%;" class="btn btn-primary" disabled="disabled"> 
						</form>
					</div>
				</div>
			</div>
