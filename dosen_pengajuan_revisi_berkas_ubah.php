	...
	<div class="d-flex" id="wrapper">
		...
		<div id="page-content-wrapper">
			...
			<div class="container-fluid">
				<h1></h1>
				<div class="card">
					<div class="card-header bg-primary text-light"><b>REVISI DATA BERKAS</b></div>
					<div class="card-body">	
						<form action="dosen_pengajuan_revisi_berkas_ubah_code.php?nip_dosen=<?php echo $nip_dosen?>&id_pengajuan=<?php echo $id_pengajuan?>&id_berkas=<?php echo $id_berkas?>" method="POST">
							...
							<div class="form-group">
								...
								<div class="col-sm-2">
									<input type="number" class="form-control" name="volume" placeholder="Volume" readonly="readonly" value="<?php echo $volume;?>"> 
								</div>	
							</div>
							<input type="submit" name="simpan" value="Simpan Berkas" style="margin: 0 0 0 53%;" class="btn btn-success"> 
						</form>
					</div>
				</div>
			</div>
