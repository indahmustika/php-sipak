<?php
	...
	$select_pengajuan ="SELECT id_pengajuan,tanggal_pengajuan,jabatan_asal,tanggal_sk,jabatan_tujuan,total_pak_akhir,status_pengajuan FROM pengajuan WHERE nip_dosen = $nip_dosen AND status_pengajuan = 'BELUM DIKIRIM' ORDER BY id_pengajuan DESC";
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<ul class="nav nav-tabs">
							<li class="nav-item">
								<a class="nav-link active" href="dosen_pengajuan_riwayat.php?nip_dosen=<?php echo $nip_dosen?>"><b>BELUM TERKIRIM</b></a>
							</li>
							<li class="nav-item">
								<a class="nav-link" href="dosen_pengajuan_riwayat_terkirim.php?nip_dosen=<?php echo $nip_dosen?>">TERKIRIM</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" href="dosen_pengajuan_riwayat_berkas_ditolak.php?nip_dosen=<?php echo $nip_dosen?>">BERKAS DITOLAK</a>
							</li>
							<li class="nav-item">
							...
							<table class="table table-bordered" id="example" class="display width="100%" cellspacing="0">
								...
								<tbody>
									...
									<tr>
										...
										<td><a href="dosen_pengajuan_tambah_berkas.php?nip_dosen=<?php echo $nip_dosen?>&id_pengajuan=<?php echo $value_pengajuan[0]?>"><?php echo $value_pengajuan[6];?></a></td>
										<td>
											<a class="btn btn-sm btn-danger" href="dosen_pengajuan_hapus_code.php?nip_dosen=<?php echo $nip_dosen?>&id_pengajuan=<?php echo $value_pengajuan[0]?>"><b>HAPUS</b></a>
										</td>
									</tr>
									<?php endforeach; ?>
								</tbody>
