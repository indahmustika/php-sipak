<?php
	...
	$select_pengajuan ="SELECT id_pengajuan,tanggal_pengajuan,jabatan_asal,tanggal_sk,jabatan_tujuan,total_pak_akhir,status_pengajuan FROM pengajuan WHERE nip_dosen = $nip_dosen AND status_pengajuan = 'TELAH REVISI' ORDER BY id_pengajuan DESC";
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<ul class="nav nav-tabs">
							...
							<li class="nav-item">
								<a class="nav-link active" href="dosen_pengajuan_riwayat_telah_revisi.php?nip_dosen=<?php echo $nip_dosen?>"><b>TELAH REVISI</b></a>
							</li>
							<li class="nav-item">
