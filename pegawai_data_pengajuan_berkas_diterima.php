<?php
	...
	$select_pengajuan = "SELECT pengajuan.id_pengajuan, pengajuan.tanggal_pengajuan, dosen.nama_dosen, pengajuan.jabatan_asal, pengajuan.jabatan_tujuan, pengajuan.total_pak_akhir FROM pengajuan INNER JOIN dosen ON pengajuan.nip_dosen=dosen.nip_dosen WHERE status_pengajuan='BERKAS DITERIMA'";
				...
				<div class="card">
					...
					<div class="card-body">
						<ul class="nav nav-tabs">
							<li class="nav-item">
								<a class="nav-link" href="pegawai_data_pengajuan.php?nip_pegawai=<?php echo $nip_pegawai;?>">BELUM DIPERIKSA</a>
							</li>
							<li class="nav-item">
							...
							<li class="nav-item">
								<a class="nav-link active" href="pegawai_data_pengajuan_berkas_diterima.php?nip_pegawai=<?php echo $nip_pegawai;?>"><b>BERKAS DITERIMA</b></a>
							</li>
							<li class="nav-item">
							...
							<table class="table table-bordered" width="100%" cellspacing="0"  id="example" class="display">
								<thead>
									<tr>
										...
										<th width="108"><center>Action</center></th>									
									</tr>
								</thead>
								<tbody>
									...
									<tr>
										...
										<td>
											<a href="pegawai_detail_berkas.php?nip_pegawai=<?php echo $nip_pegawai?>&id_pengajuan=<?php echo $value_pengajuan[0];?>" class="btn btn-success btn-sm text-light">Berkas</a>
											<a href="pegawai_detail_penilai.php?nip_pegawai=<?php echo $nip_pegawai?>&id_pengajuan=<?php echo $value_pengajuan[0];?>" class="btn btn-info btn-sm text-light">Penilai</a>
										</td>
									</tr>
									<?php endforeach; ?>
								</tbody>
