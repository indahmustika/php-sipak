<?php
	...
	$select_pengajuan = "SELECT pengajuan.id_pengajuan, pengajuan.tanggal_pengajuan, dosen.nama_dosen, pengajuan.jabatan_asal, pengajuan.jabatan_tujuan, pengajuan.total_pak_akhir FROM pengajuan INNER JOIN dosen ON pengajuan.nip_dosen=dosen.nip_dosen WHERE status_pengajuan='BERKAS DITOLAK'";
				...
				<div class="card">
					...
					<div class="card-body">
						<ul class="nav nav-tabs">
							...
							<li class="nav-item">
								<a class="nav-link active" href="pegawai_data_pengajuan_berkas_ditolak.php?nip_pegawai=<?php echo $nip_pegawai;?>"><b>BERKAS DITOLAK</b></a>
							</li>
							<li class="nav-item">
								<a class="nav-link" href="pegawai_data_pengajuan_telah_revisi.php?nip_pegawai=<?php echo $nip_pegawai;?>">TELAH DIREVISI</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" href="pegawai_data_pengajuan_berkas_diterima.php?nip_pegawai=<?php echo $nip_pegawai;?>">BERKAS DITERIMA</b></a>
							</li>
							<li class="nav-item">
							...
							<table class="table table-bordered" width="100%" cellspacing="0"  id="example" class="display">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<a href="pegawai_detail_berkas_ditolak.php?nip_pegawai=<?php echo $nip_pegawai?>&id_pengajuan=<?php echo $value_pengajuan[0];?>" class="btn btn-info btn-sm text-light">Lihat Berkas</a>
										</td>
									</tr>
									<?php endforeach; ?>
								</tbody>
