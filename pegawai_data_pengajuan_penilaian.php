<?php
	...
	$select_pengajuan = "SELECT pengajuan.id_pengajuan,pengajuan.tanggal_pengajuan,dosen.nama_dosen,pengajuan.jabatan_asal,pengajuan.jabatan_tujuan,pengajuan.total_pak_akhir FROM pengajuan INNER JOIN dosen ON pengajuan.nip_dosen=dosen.nip_dosen WHERE status_pengajuan='PENILAIAN SELESAI'";
				...
				<div class="card">
					...
					<div class="card-body">
						<ul class="nav nav-tabs">
							...
							<li class="nav-item">
								<a class="nav-link active" href="pegawai_data_pengajuan_penilaian.php?nip_pegawai=<?php echo $nip_pegawai;?>"><b>TELAH DINILAI</b></a>
							</li>
							<li class="nav-item">
							...
							<table class="table table-bordered" width="100%" cellspacing="0"  id="example" class="display">
								<thead>
									<tr>
										...
										<th width="100"><center>PAK Akhir</center></th>
										<th width="95"><center>Action</center></th>
									</tr>
								</thead>
								<tbody>
									...
									<tr>
										...
										<td>
											<a class="btn btn-sm btn-success" href="pegawai_persetujuan.php?nip_pegawai=<?php echo $nip_pegawai;?>&id_pengajuan=<?php echo $value_pengajuan[0];?>">PERSETUJUAN</a>
										</td>
									</tr>
									<?php endforeach; ?>
								</tbody>
