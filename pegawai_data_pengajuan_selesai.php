<?php
	...
	$select_pengajuan = "SELECT pengajuan.id_pengajuan, pengajuan.tanggal_pengajuan, dosen.nama_dosen, pengajuan.jabatan_asal, pengajuan.jabatan_tujuan,pengajuan.total_pak_akhir, pengajuan.status_pengajuan FROM pengajuan INNER JOIN dosen ON pengajuan.nip_dosen=dosen.nip_dosen WHERE status_pengajuan='DITERIMA' OR status_pengajuan = 'DITOLAK'";
				...
				<div class="card">
					...
					<div class="card-body">
						<ul class="nav nav-tabs">
							...
							<li class="nav-item">
								<a class="nav-link active" href="pegawai_data_pengajuan_selesai.php?nip_pegawai=<?php echo $nip_pegawai;?>"><b>SELESAI</b></a>
							</li>
						</ul>
						<h1></h1>
							...
							<table class="table table-bordered" width="100%" cellspacing="0"  id="example" class="display">
								<thead>
									<tr>
										...
										<th width="80"><center>PAK Akhir</center></th>
								...
								<tbody>
									...
									<tr>
										...
										<td><a href="pegawai_detail_selesai.php?nip_pegawai=<?php echo $nip_pegawai;?>&id_pengajuan=<?php echo $value_pengajuan[0];?>"><b><?php echo $value_pengajuan[6];?></b></a></td>
									</tr>
									<?php endforeach; ?>
								</tbody>
							</table>
