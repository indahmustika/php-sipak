				...
				<div class="card">
					...
					<div class="card-body">
						<ul class="nav nav-tabs">
							<li class="nav-item">
								<a class="nav-link" href="penilai_daftar_pengajuan.php?nip_penilai=<?php echo $nip_penilai;?>">BELUM DINILAI</a>
							</li>
							<li class="nav-item">
								<a class="nav-link active" href="penilai_daftar_pengajuan_selesai.php?nip_penilai=<?php echo $nip_penilai;?>"><b>TELAH DINILAI</b></a>
							</li>
						</ul>
						<h1></h1>
							...
							<table class="table table-bordered" width="100%" cellspacing="0" id="example1" class="display">
								<thead>
									<tr>
										...
										<th width="85"><center>Tanggal</center></th>
										<th><center>Nama</center></th>
										<th width="140"><center>Jabatan</center></th>
										<th width="140"><center>Jabatan Tujuan</center></th>
								...
								<tbody>
									<?php foreach($data_pengajuan1 as $value_pengajuan1):?>
										<tr>
											...
											<td><a class="btn btn-sm btn-primary" href="penilai_data_nilai_penilai1.php?nip_penilai=<?php echo $nip_penilai;?>&id_pengajuan=<?php echo $value_pengajuan1[0]?>">Lihat Nilai</a> 
											</td>
										</tr>
									<?php endforeach;?>
								</tbody>
								...
								<tbody>
									<?php foreach($data_pengajuan2 as $value_pengajuan2):?>
										<tr>
											...
											<td><a class="btn btn-sm btn-primary" href="penilai_data_nilai_penilai2.php?nip_penilai=<?php echo $nip_penilai;?>&id_pengajuan=<?php echo $value_pengajuan2[0]?>">Lihat Nilai</a> 
											</td>
										</tr>
									<?php endforeach;?>
								</tbody>
