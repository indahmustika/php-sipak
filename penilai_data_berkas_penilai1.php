<?php
	...
	$select_berkas = "SELECT berkas_pak.id_berkas, rubrik.aspek_rubrik, rubrik.kegiatan_rubrik, berkas_pak.bukti_berkas, berkas_pak.poin_1, berkas_pak.status_berkas FROM berkas_pak INNER JOIN rubrik ON berkas_pak.kode_rubrik=rubrik.kode_rubrik WHERE id_pengajuan='$id_pengajuan'";
	...
	$select_poin = "SELECT SUM(poin_1) FROM berkas_pak WHERE id_pengajuan='$id_pengajuan'";
								...
								<tbody>
									...
									foreach($data_berkas as $value_berkas):
										...
										<tr>
											...
											<td>
												<a class="btn btn-sm btn-success" href="penilai_nilai1.php?nip_penilai=<?php echo $nip_penilai;?>&id_berkas=<?php echo $value_berkas[0];?>&id_pengajuan=<?php echo $id_pengajuan;?>"><b>DETAIL & NILAI</b></a>
											</td>
										</tr>
									<?php endforeach; ?>
								</tbody>
						...
						<div class="table-responsive">
							<table class="table">
								<tr>
									...
									<td width="148">
										<a href="penilai_submit_nilai1.php?nip_penilai=<?php echo $nip_penilai;?>&id_pengajuan=<?php echo $id_pengajuan;?>&status_pengajuan=<?php echo $status_pengajuan;?>" class="btn btn-primary" style="margin: 0 0 0 27%;"><b>SUBMIT</b></a>
									</td>
								</tr>
							</table>
						</div>
