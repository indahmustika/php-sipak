<?php
	...
	$select_berkas = "SELECT berkas_pak.id_berkas, rubrik.aspek_rubrik, rubrik.kegiatan_rubrik, berkas_pak.bukti_berkas, berkas_pak.poin_2/berkas_pak.volume, berkas_pak.volume, berkas_pak.poin_2 FROM berkas_pak INNER JOIN rubrik ON berkas_pak.kode_rubrik=rubrik.kode_rubrik WHERE id_berkas = $id_berkas;";
...
<body>
	<div class="d-flex" id="wrapper">
		...
		<div id="page-content-wrapper">
			...
			<div class="container-fluid">
				<h1></h1>
				<div class="card">
					<div class="card-header bg-primary text-light"><b>TENTUKAN NILAI BERKAS</b></div>
					<div class="card-body">
						<h1></h1>
						...
						<div class="table-responsive table-borderless">
							<table class="table" id="tabelberkas" width="100%" cellspacing="0">
								<tr>
									...
									<td>
										<div class="col-sm-2">
											<input class="form-control" type="text" name="poin_awal" id="poin_awal" value="<?php echo $poin_awal;?>"> <a href="javascript: void(0)" onClick="calc()"></a>
										</div>
									</td>
								</tr>
								<tr>
								...
								<form action="penilai_nilai2_code.php?nip_penilai=<?php echo $nip_penilai;?>&id_berkas=<?php echo $id_berkas;?>&id_pengajuan=<?php echo $id_pengajuan;?>" method="POST">
									<tr>
										<td>Total Poin</td>
										<td>
											<div class="col-sm-2">
												<input class="form-control" readonly="readonly" type="text" name="poin_2" id="poin_2" value="<?php echo $poin_2;?>">
											</div>
										</td>
									</tr>
									<tr>
										<td></td>
										<td>
											<input type="submit" name="simpan" value="Simpan" style="margin: 0 0 0 1.75%;" class="btn btn-success">
										</td>
									</tr>
								</form>
							</table>
	...
	<script type="text/javascript">
		$("#poin_awal,#volume").keyup(function () {
			$('#poin_2').val($('#volume').val() * $('#poin_awal').val());
		});
	</script>
	<script>
